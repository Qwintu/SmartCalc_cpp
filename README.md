# SmartCalc v2.0 - Проект еще не закончен
...
>В данном проекте предстоит в парадигме объектно-ориентированного программирования реализовать на языке программирования С++ расширенную версию обычного калькулятора, имеющую те же самые функции, что и разработанное ранее приложение в проекте SmartCalc v1.0.  
